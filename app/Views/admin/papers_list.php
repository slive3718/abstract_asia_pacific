                ...
                $.each(response.data, function(i, val) {
                    ...
                    if (val.dpc) {
                        $.each(val.dpc, function(i, dpc) {
                            ...
                            dpc_final += '<div class="card bg-transparent p-1 shadow-sm"><span class="fw-bolder"> Recommendation:</span> ' +(dpc.is_recommended_for_publications ? dpc.is_recommended_for_publications : '') + '</div> ';
                        });
                    }
