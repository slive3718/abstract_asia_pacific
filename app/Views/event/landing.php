    ...
    <div class="container shadow-lg glass-container container-landing">
        <div class="card">
            ...
            <div class="container p-5 ">
                ...
                <ul>
                    <li>By submitting an abstract to Asia Pacific 2026, abstract authors agree that at least one (l) author will attend the meeting and will be available to present on the date and time assigned.
                        <ul>
