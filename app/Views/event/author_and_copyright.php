...
<!--    <script  type="text/javascript" src="--><?php //=base_url('assets/js/submissionFunction.js?v=5')?><!--"></script>-->
<!--    <script  type="text/javascript" src="--><?php //=base_url('assets/js/locationAutocomplete.js')?><!--"></script>-->
