            ...
            <!-- Financial Relationship Guidelines -->
                <div class="mt-5">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check mb-2">
                            <input type="checkbox" class="form-check-input" id="disclosure_relationship" name="disclosure_relationship" value="1"  <?= ( !empty($author['disclosure_relationship']) && $author['disclosure_relationship'] == '1' ? 'checked' : '')?>>
...
<script>
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href = '<?= base_url('author/attestation') ?>';
                    } else {
        ...
        if (selectedOrganizations && Object.keys(selectedOrganizations).length > 0) {
